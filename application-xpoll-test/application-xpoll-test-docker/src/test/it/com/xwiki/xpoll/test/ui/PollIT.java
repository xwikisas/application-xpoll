...
class PollIT
{
    ...
    /**
     * XWIKI-22433 introduced a new way of displaying a warning using Velocity macro. When XWiki version is greater than
     * 17.3, to avoid failing tests, the message should no longer include "Warning:"
     */
